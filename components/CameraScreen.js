...
//Aktiveres ved tryk på knappen fra createContent siden
const CameraScreen = ({navigation}) => {
    ...
    useEffect(() => {
        (async () => {
            /*Får tilladelse til at benytte kameraet*/
            ...
            /*Når tilladelse giver sættes ny status*/
    ...
    const snap = async () => {
        ...
        /*Billedet lægges forrest i arrayet*/
                ...
                <Camera style={styles.camera} type={type} ref={cameraRef}>
                    <View style={{flexDirection:"column",alignContent:"center",flex:1,padding:20}}>
                        <View style={styles.buttonContainer}>
                           ...
                           {/*Vælg billeder fra telefonen - benytter pickImage funktionen*/}
                            <TouchableOpacity
                                style={styles.button}
                                onPress={pickImage}
                            >
...
//Stylesheet for komponenten med specifikke værdier til denne side - blandt andet hvid tekst
